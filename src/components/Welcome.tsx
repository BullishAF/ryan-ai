export const Welcome: React.FC = () => (
  <div className="bg-white border-gray-100 border-2 rounded-lg px-8 py-5 mr-20 w-full">
    ...
    <p className="text-center text-xl text-base/loose">
      Don't worry, I'm WAY smarter than Ryan(The human version) that built me 😉
    </p>
     <p className="text-center text-base/loose">
       Ask questions or chat with me in the text box below.
    </p>
    <p className="text-lg font-medium mb-2">You can try out some examples below ⬇</p>
  </div>
);
